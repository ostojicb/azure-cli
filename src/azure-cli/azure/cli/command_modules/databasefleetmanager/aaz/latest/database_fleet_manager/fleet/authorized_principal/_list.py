...
@register_command(
    "database-fleet-manager fleet authorized-principal list",
    is_preview=True,
)
class List(AAZCommand):
    """List all authorized principals in a fleet.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AuthorizedPrincipalsList(ctx=self.ctx)()
    ...
    class AuthorizedPrincipalsList(AAZHttpOperation):
