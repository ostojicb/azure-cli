...
@register_command(
    "database-fleet-manager fleet firewall-rule create",
    is_preview=True,
)
class Create(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.databasefleetmanager/fleets/{}/firewallrules/{}", "2023-08-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FirewallRulesPut(ctx=self.ctx)()
    ...
    class FirewallRulesPut(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("endIpAddress", AAZStrType, ".end_ip_address")
                properties.set_prop("startIpAddress", AAZStrType, ".start_ip_address")
