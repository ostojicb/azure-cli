...
@register_command(
    "database-fleet-manager fleet fleetspace database show",
    is_preview=True,
)
class Show(AAZCommand):
    """Get a fleet database.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FleetDatabaseGetDatabase(ctx=self.ctx)()
    ...
    class FleetDatabaseGetDatabase(AAZHttpOperation):
