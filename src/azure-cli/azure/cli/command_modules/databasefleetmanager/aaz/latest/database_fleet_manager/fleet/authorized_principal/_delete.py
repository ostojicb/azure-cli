...
@register_command(
    "database-fleet-manager fleet authorized-principal delete",
    is_preview=True,
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete an authorized principal.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.AuthorizedPrincipalsDelete(ctx=self.ctx)()
    ...
    class AuthorizedPrincipalsDelete(AAZHttpOperation):
