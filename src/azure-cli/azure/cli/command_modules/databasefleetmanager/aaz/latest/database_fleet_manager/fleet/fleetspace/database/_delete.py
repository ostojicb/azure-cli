...
@register_command(
    "database-fleet-manager fleet fleetspace database delete",
    is_preview=True,
    confirmation="Are you sure you want to perform this operation?",
)
class Delete(AAZCommand):
    """Delete a fleet database.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.FleetDatabaseDeleteDatabase(ctx=self.ctx)()
    ...
    class FleetDatabaseDeleteDatabase(AAZHttpOperation):
