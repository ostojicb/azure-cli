...
@register_command(
    "database-fleet-manager fleet firewall-rule list",
    is_preview=True,
)
class List(AAZCommand):
    """List all firewall rules in a fleet.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.FirewallRulesList(ctx=self.ctx)()
    ...
    class FirewallRulesList(AAZHttpOperation):
